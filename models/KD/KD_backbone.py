...
class Model(nn.Module):
    def __init__(self, in_chans=3, num_heads=[1, 2, 4, 8], num_classes=6, depths=[3, 3, 9, 3], norm_layer=nn.BatchNorm2d, name=None, **kwargs):
        ...
        self.project_s = nn.Sequential(nn.Conv2d(student_dims[-1], teacher_dims[-1], 1, 1, 0),
        ...
        self.register_buffer('pixel_queue', torch.randn(num_classes, 60, self.contrast_dim))
